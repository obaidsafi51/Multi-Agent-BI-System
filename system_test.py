...
class SystemTestSuite:
    ...
    async def setup(self):
        ...
        print("🚀 Setting up System Test Suite...")
    ...
    async def test_nlp_agent_integration(self) -> bool:
        ...
        try:
            ...
            async with self.session.post(
                ...
                if response.status == 200:
                    ...
                    # Check if NLP agent understood the query
                    return "intent_type" in data and data.get("success", False)
                else:
                    print(f"   NLP request failed with status: {response.status}")
                    return False
    ...
    async def test_data_agent_connection(self) -> bool:
        ...
        try:
            ...
            async with self.session.post(
                ...
                if response.status == 200:
                    ...
                    print(f"   Data request failed with status: {response.status}")
                    return False
                    
        except Exception as e:
            print(f"   Data agent test failed: {e}")
            # Don't fail if data agent is not available
            return True
    
    async def test_viz_agent_integration(self) -> bool:
        ...
        try:
            ...
            async with self.session.post(
                ...
                if response.status == 200:
                    ...
                    print(f"   Viz request failed with status: {response.status}")
                    return False
            ...
            if nlp_result.get("success"):
                ...
                async with self.session.post(
                    ...
                    if viz_response.status == 200:
                        viz_result = await viz_response.json()
        ...
        try:
            ...
            for i in range(5):
                ...
                test_data = {
                    ...
                    "data": [{"x": j, "y": j * 2} for j in range(100)]
                }
    ...
    async def test_error_handling(self) -> bool:
        ...
        try:
            ...
            invalid_requests = [
                ...
                {"request_id": "test", "data": "invalid_data_format"}  # Wrong data type
            ]
            ...
            for i, invalid_req in enumerate(invalid_requests):
                async with self.session.post(
                    ...
                    if response.status in [400, 422] or response.status == 200:
                        if response.status == 200:
                            data = await response.json()
