...
export function useWebSocketClient(config?: Partial<WebSocketClientConfig>): UseWebSocketReturn {
  ...
  }, [clientState.reconnectAttempts, fullConfig.maxReconnectAttempts, fullConfig.reconnectInterval, fullConfig.maxReconnectInterval]);
  ...
  }, [fullConfig, updateConnectionState, handleMessage, reconnect]);
